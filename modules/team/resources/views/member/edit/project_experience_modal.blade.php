    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ URL::route('core::upload.skill') }}" method="post" 
                    enctype="multipart/form-data" class="skill-modal-form" id="form-employee-project_experience">
                ...
                <div class="modal-body">
                    <div class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="project_experience-name">{{ trans('team::view.Name') }}</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="project_experience-responsible">{{ trans('team::view.Responsible') }}</label>
                            <div class="input-box col-md-9">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="project_experience-start">{{ trans('team::view.Start at') }}</label>
                            <div class="input-box col-md-9">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="project_experience-end">{{ trans('team::view.End at') }}</label>
                            <div class="input-box col-md-9">
