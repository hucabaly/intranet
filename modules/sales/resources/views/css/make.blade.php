            ...
            <section>
                ...
                <div class="row project-detail">
                    ...
                    @foreach($cssCate as $item)
                            ...
                            @foreach($item['cssCateChild'] as $itemChild)
                                ...
                                @if($itemChild['questionsChild'])
                                    ...
                                    <div class="row container-question">
                                        ...
                                        <div class="col-xs-12 col-sm-5 comment"><input type="text" class="comment-question form-control" type="text" maxlength="1000" data-questionid="{{$questionChild->id}}" onkeyup="checkPoint(this);" /></div>
                                    </div>
                                    @endforeach
                                @endif
                            @endforeach
                        @elseif($item['questions'])
                            ...
                            <div class="row container-question">
                                ...
                                <div class="col-xs-12 col-sm-5 comment"><input type="text" class="comment-question form-control" type="text" maxlength="1000" data-questionid="{{$question->id}}" onkeyup="checkPoint(this);" /></div>
                            </div>
                            @endforeach
                        @endif
                    @endforeach
                    ...
                    <div class="row container-question">
                        ...
                        <div class="col-xs-12 col-sm-5 comment"><input type="text" class="comment-question form-control" type="text" maxlength="1000" data-questionid="{{$overviewQuestionId}}" id="comment-tongquat" onkeyup="checkPoint(this);" /></div>
                    </div>
                    <!-- Proposed -->
