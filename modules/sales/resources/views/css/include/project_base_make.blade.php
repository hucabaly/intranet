<table class="table table-bordered bang1">
    <tr><td colspan="5" class="top"><label class="project-info-title">{{ trans('sales::make_css.Project infomation') }}</label></td></tr>
      <tr>
          <td class="title"><label>{{ trans('sales::make_css.Project name') }}<label</td>
        <td></td>
        <td class="title2"><label>{{ trans('sales::make_css.Period') }}</label></td>
        <td></td>
        <td class="make_date"><label>{{ trans('sales::make_css.Make date') }}</label></td>
    </tr>
    <tr>
        <td class="title"><label>{{ trans('sales::make_css.Sale name') }}</label></td>
        <td></td>
        <td class="title2"><label>{{ trans('sales::make_css.Customer name') }}</label></td>
        <td></td>
        <td rowspan="3" class="diemso-base">
            <div>{{ trans('sales::make_css.Total mark') }}</div>
            <div class="diem">68.00</div>
        </td>
    </tr>
    <tr>
        <td class="title"><label>{{ trans('sales::make_css.PM name') }}</label></td>
        <td></td>
        <td class="title2"><label>{{ trans('sales::make_css.Make name') }}</label></td>
        <td><input type="text" id="make_name" name="make_name" ></td>

    </tr>
    <tr>
        <td class="title"><label>{{ trans('sales::make_css.BrSE name') }}</label></td>
        <td></td>
        <td class="title2"><label>{{ trans('sales::make_css.Make email') }}</label></td>
...
<table class="table table-bordered bang2 table-base">
  <!-- header -->
  <tr class="header">
      <td><label>{{ trans('sales::make_css.No.') }}</label></td>
    <td><label>{{ trans('sales::make_css.Question') }}</label></td>
    <td class="reply"><label>{{ trans('sales::make_css.Rating') }}</label></td>
    <td class="comment"><label>{{ trans('sales::make_css.Comment') }}</label></td>
</tr>
